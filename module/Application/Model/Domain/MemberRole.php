 ...
 * MemberRole 
 *
 * @ORM\Table(name="`MEMBERROLE`")
 * @ORM\Entity(repositoryClass="Application\Model\Infrastructure\Repositories\MemberRoleRepository")
 */
class MemberRole 
{
    /**
     ...
     * @ORM\JoinTable(name="MEMBERROLEPERMISSIONS",
     *     joinColumns={@ORM\JoinColumn(name="MEMBERROLEID", referencedColumnName="ID")},
     ...
     * @ORM\SequenceGenerator(sequenceName="MEMBERROLE_SEQ")
